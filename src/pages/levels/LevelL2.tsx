...
import { 
  CHAPTER2_ARTICLE_V3, 
  CHAPTER2_QUESTIONS_V3 
} from '../../data/questions/reading/chapter2-v3';
...
const LevelL2 = () => {
      ...
      <div className="game-container">
        ...
        >
          ...
          <div className="card mt-8" style={{ maxWidth: '600px', margin: '32px auto', textAlign: 'left' }}>
            ...
            <ul style={{ paddingLeft: '20px', lineHeight: '2' }}>
              <li>✅ 可滚动长文阅读（{CHAPTER2_ARTICLE_V3.wordCount} 词）</li>
            ...
            <ul style={{ paddingLeft: '20px', lineHeight: '2' }}>
              ...
              <li>⏱️ 预计阅读时间：{CHAPTER2_ARTICLE_V3.estimatedReadingTime} 分钟</li>
              <li>📊 及格分数：70分</li>
            </ul>
          </div>
  ...
  if (gameState === 'playing') {
    return (
      <ReadingGameV3
        articleTitle={CHAPTER2_ARTICLE_V3.title}
        articleSource={`选自 Chapter ${CHAPTER2_ARTICLE_V3.chapterNumber}: ${CHAPTER2_ARTICLE_V3.chapterTitle}`}
        articleContent={CHAPTER2_ARTICLE_V3.content}
        wordCount={CHAPTER2_ARTICLE_V3.wordCount}
        questions={CHAPTER2_QUESTIONS_V3}
        articleId={CHAPTER2_ARTICLE_V3.id}
      ...
      <div className="game-container">
        ...
        >
          ...
          <p style={{ color: passed ? '#2a9d8f' : '#e76f51', marginTop: '8px', fontSize: '1.2rem' }}>
            {passed ? '你成功完成了 L2 v3.0 测评！' : '继续加油，下次一定能通过！'}
          </p>
